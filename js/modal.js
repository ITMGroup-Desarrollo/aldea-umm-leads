 const modal = document.getElementById('formModal');
    ...
    document.getElementById('hubspotForm').addEventListener('submit', e => {
      ...
      fetch("https://api.hsforms.com/submissions/v3/integration/submit/39595277/204dfa24-d904-4215-97bb-bff75709aeb9", {
        method: "POST",
    ...
    function insertCalendar() {
      ...
      calendarDiv.setAttribute("data-src", `https://meetings.hubspot.com/octavio23?embed=true&${queryParams}`);
